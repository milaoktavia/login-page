...
CREATE TABLE `admin` (
  ...
  `pasword` varchar(255) COLLATE utf8mb4_unicode_520_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `pasword` varchar(50) COLLATE utf8mb4_unicode_520_ci NOT NULL,
...
INSERT INTO `user` VALUES ('mila','123');
...
-- Dump completed on 2022-11-30 10:39:49
